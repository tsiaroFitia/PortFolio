    ...
    >
      <div className="max-w-4xl mx-auto px-4 w-full">
        <motion.h2
          ...
          viewport={{ once: false }}
          className="text-4xl text-center font-bold mb-12 bg-gradient-to-r from-teal-500 to-indigo-600 bg-clip-text text-transparent"
        >
          Contact Me
        </motion.h2>
        <div className="grid grid-cols-1 md:grid-cols-2 justify-between gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.3 }}
            viewport={{ once: false }}
            className="p-8 rounded-xl border-white/10 border-2 hover:-translate-y-1 transition-all  flex flex-col justify-evenly"
          >
            <h1 className="text-2xl font-bold relative text-white cursor-pointer mb-8">
              My Social Media
              <span className="absolute left-0 -bottom-3 w-50 h-1 bg-gradient-to-r from-teal-400 via-blue-500 to-indigo-600 rounded-full"></span>
            </h1>
          ...
          >
            <h1 className="text-2xl font-bold relative text-white cursor-pointer mb-8">
              Send a Message
              <span className="absolute left-0 -bottom-3 w-47 h-1 bg-gradient-to-r from-teal-400 via-blue-500 to-indigo-600 rounded-full"></span>
            </h1>
